...
@Service
public class SendUserServiceEvent {

    private final KafkaTemplate<String, String> kafkaTemplate;

    private final String TOPIC = "user.event";

    public SendUserServiceEvent(KafkaTemplate<String, String> kafkaTemplate) {
        this.kafkaTemplate = kafkaTemplate;
    }

    @Async("taskExecutor")
    public void sendUserRequest(String userId) {
        CompletableFuture<SendResult<String, String>> future = kafkaTemplate.send(TOPIC, userId);
