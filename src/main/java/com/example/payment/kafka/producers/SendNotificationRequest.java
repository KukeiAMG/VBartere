...
public class SendNotificationRequest {
    ...
    private final String TOPIC = "payment.purchaseinfo.notification";

    public SendNotificationRequest(KafkaTemplate<String, String> kafkaTemplate) {
        this.kafkaTemplate = kafkaTemplate;
    }

    @Async("taskExecutor")
    public void sendNotificationRequest(String notificationPurchaseDTO) {
        try {
            CompletableFuture<SendResult<String, String>> future = kafkaTemplate.send(TOPIC, notificationPurchaseDTO);
